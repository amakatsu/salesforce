...
export default class MainApp extends LightningElement {
    ...
    get hasActivePage() {
        return ['search', 'profile-view', 'profile-edit', 'settings'].includes(this.currentPage);
    }
    ...
    handleNavigation(event) {
        ...
        console.log('Current state - currentPage:', this.currentPage, 'selectedUserId:', this.selectedUserId);
    }
